...
*/
	...
	/*
		for standard  mode
		TwSCLH = 4nS; TrSCL = 1000nS; Tplck1 = 1/ 16Mhz = 62.5nS
		CRR = (TwSCLH + TrSCL) / Tplck1 = 80
	*/
	
	// Configure the rise time register
	I2C1->TRISE = 17;  // check PDF again
	/*
	TRISE = TrSCL/Tplck1 + 1 = 1000nS/62.5nS+1 = 17
	*/
...
*/	
	while (I2C1->SR2 & (0b1<<1)) {} // Wait until bus is free
...
*/	
	while (!(I2C1->SR1 & (0b1<<7)));  // wait for TXE bit to set
	I2C1->DR = data;
	while (!(I2C1->SR1 & (0b1<<2)));  // wait for BTF bit to set
}
...
*/	
	...
	while (!(I2C1->SR1 & (0b1<<1)));  // wait for ADDR bit to set
